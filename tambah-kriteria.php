...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$simpan = mysqli_query($koneksi,"INSERT INTO kriteria (id_kriteria, kode_kriteria, nama, type, ada_pilihan) VALUES ('', '$kode_kriteria', '$nama', '$type', '1')");
		if($simpan) {
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold green-icon">Tambah Data Kriteria</h6>
    </div>
