...
if(isset($_POST['submit'])){
	...
	if(empty($errors)){
		...
		$update = mysqli_query($koneksi,"UPDATE kriteria SET kode_kriteria = '$kode_kriteria', nama = '$nama', type = '$type', ada_pilihan = '1' WHERE id_kriteria = '$id_kriteria'");
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 green-icon">Data Kriteria</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold green-icon">Edit Data Kriteria</h6>
    </div>
