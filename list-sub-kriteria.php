...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 green-icon"><i class="fas fa-fw fa-cubes"></i> Data Sub Kriteria</h1>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold green-icon">Daftar Data Sub Kriteria</h6>
    </div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
			<h6 class="m-0 font-weight-bold green-icon"><?= $data['nama']." (".$data['kode_kriteria'].")" ?></h6>
	...
	<!-- Tampilan Halaman Data Sub Kriteria -->
    <div class="card-body">
