...
<html lang="en">
    ...
    <body class="bg-gradient-success">
		<nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-success" style="font-weight: 900;" href="index.php"> Sistem Pendukung Keputusan Kesesuaian Lahan Tamanan Padi</a>
        ...
        <div class="container">
            <!-- Outer Row -->
            <div class="row d-plex justify-content-center mt-6">				
